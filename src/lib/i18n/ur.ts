...
export const ur: TranslationStrings = {
    ...
    'delete.onlyTitle': 'صرف اس فرد کو حذف کریں',
    'delete.onlyDescription':
        'اس فرد اور ان کے ازدواجی روابط کو ہٹا دیں۔ اولاد شجرے میں رہے گی اور محفوظ طریقے سے دوبارہ جوڑ دی جائے گی۔',
    'delete.branchTitle': 'اس فرد اور تمام اولاد کو حذف کریں',
    'delete.branchDescription':
        'اس فرد کو ہٹا دیں اور {count} اولاد کو حذف شدہ نشان زد کریں۔ شریکِ حیات برقرار رہیں گے۔',
    'delete.rootOnlyBranch':
        'بنیادی فرد کو صرف مکمل شاخ کے ساتھ حذف کیا جا سکتا ہے، کیونکہ ان کی اولاد کو سنبھالنے کے لیے کوئی والدین نہیں ہیں۔',
